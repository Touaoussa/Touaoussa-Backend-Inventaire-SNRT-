...
public interface ArticleJdeRepository  extends JpaRepository<ArticleJde,Long> {
	...
	/*@Query(value=""
			...
			,nativeQuery = true)*/
	@Query(value="select  PDITM as numarticle, PDLITM as nomarticle, PDDSC1 as description, PDUORG as quantite, PDPRRC as prixunitaire, PDAEXP as prixtotal , PDDOCO as support_id from proddta.F4311 where PDDCTO=:type and  PDDOCO= :numsupport "
			,nativeQuery = true)
